...
//    private ActionBar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("");
        toolbarTitle.setText("My Habits");
        toolbar.setBackgroundColor(getColor(R.color.habit_title_color));
        if (savedInstanceState == null) {
            Bundle extras = getIntent().getExtras();
            if(extras != null){
//            Bundle extras = getIntent().getExtras();
                String str = extras.getString("HABIT_NAME");

                TextView textView = findViewById(R.id.compnew);
                textView.setText(str);
                textView.setVisibility(View.VISIBLE);
                ProgressBar progressBar=findViewById(R.id.pbcompnew);
                progressBar.setVisibility(View.VISIBLE);
                Button bt=findViewById(R.id.logcompnew);
...
//        });
    ...
    public void LogHabit(View view) {
        ...
        if (view.getId()==R.id.logcompnew){
            habit=findViewById(R.id.compnew);
        }
        else{
