...
//
//        toolbar.setTitle("");
//        toolbarTitle.setText("Read 5 Pages of book");
//        toolbar.setBackgroundColor(getColor(R.color.habit_title_color));


        d1.set(Calendar.YEAR, 2019);
        d1.set(Calendar.MONTH, 12);
        d1.set(Calendar.DAY_OF_MONTH, 17);
        disable.add(d1);


        final CalendarDay days = CalendarDay.from( 2019 , 12 , 17 );
        final CalendarDay days2 = CalendarDay.from( 2019 , 12 , 18 );
        final CalendarDay days3 = CalendarDay.from( 2019 , 12 , 1 );
        final CalendarDay days4 = CalendarDay.from( 2019 , 12 , 3 );
        final CalendarDay days5 = CalendarDay.from( 2019 , 12 , 5 );
        final CalendarDay days6 = CalendarDay.from( 2019 , 12 , 6 );
        //date for today
        final CalendarDay today = CalendarDay.from( 2019 , 12 , 21 );
